...
class MainClass
{
    public static void Main (string[] args)
    {
        ...
        Encargado encargado = new Encargado("Jose", 25, "M");
        ...
        Estudiante estudiante1 = new Estudiante("Mateo", 20, "M");
        Estudiante estudiante2 = new Estudiante("Marcos", 21, "M");
        Estudiante estudiante3 = new Estudiante("Lucas", 19, "M");
        Estudiante estudiante4 = new Estudiante("Juan", 22, "M");
